import ServiceCard from "@/components/services/listing/ServiceCard";
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {services.length > 0 ? (
          ...
          <div className="mt-10 rounded-2xl border border-cool-gray-200 bg-cool-gray-50 p-8 text-center">
