  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1fr_0.9fr] lg:items-center lg:px-8">
        <div>
          {service.data.status && (
            <span className="inline-flex rounded-full border border-emerald-brand-300/25 bg-emerald-brand-500/10 px-3 py-1.5 text-xs font-bold text-emerald-brand-300">
              {service.data.status}
            </span>
          )}
